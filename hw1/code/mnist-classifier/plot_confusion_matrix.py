...
if __name__ == '__main__': 
    ...
    for batch in valid_dataloader:
        inputs, annotations = batch['input'], batch['annotation']
        outputs = net.forward(inputs)
        
        for predicted, ground_truth in zip(outputs, annotations):
            confusion_matrix[torch.argmax(predicted)][ground_truth] += 1
