...
def ReprojectionError(P, point3D, point2D):
    ...
    homo_point3D = MakeHomogeneous(point3D)
    projected_homo_point2D = P @ homo_point3D.transpose()
    projected_point2D = HNormalize(projected_homo_point2D)

    return point2D - projected_point2D
